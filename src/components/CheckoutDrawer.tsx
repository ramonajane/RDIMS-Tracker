  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent
          className="[&>button.absolute]:hidden max-w-full w-screen h-screen p-0 gap-0 rounded-none border-0 sm:max-w-full flex flex-col"
      ...
      <Dialog open={!!pending} onOpenChange={(o) => { if (!o) cancelPending(); }}>
        <DialogContent className="[&>button.absolute]:hidden max-w-sm w-[92vw] rounded-2xl border-0 bg-white p-0 shadow-2xl gap-0 overflow-hidden">
          {/* Popup header */}
