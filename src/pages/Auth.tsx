  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full bg-blue-400/10 blur-3xl" />
      </div>
        ...
        <div className="rounded-3xl border border-blue-700/40 bg-blue-950/60 backdrop-blur-xl p-8 shadow-2xl shadow-blue-900/50">
          ...
          <Tabs defaultValue="in">
            <TabsList className="grid grid-cols-2 w-full bg-blue-900/40 border border-blue-700/40 p-1 rounded-xl mb-6">
              <TabsTrigger value="in" className="rounded-lg text-blue-400 data-[state=active]:bg-blue-500 data-[state=active]:text-white data-[state=active]:shadow-md font-medium transition-all">
                Sign In
              </TabsTrigger>
              <TabsTrigger value="up" className="rounded-lg text-blue-400 data-[state=active]:bg-blue-500 data-[state=active]:text-white data-[state=active]:shadow-md font-medium transition-all">
                Sign Up
              </TabsTrigger>
            </TabsList>
            ...
            {(["in", "up"] as const).map(m => (
              <TabsContent key={m} value={m} className="space-y-4 mt-0">
                ...
                <Button onClick={() => handle(m)} disabled={busy} size="lg"
